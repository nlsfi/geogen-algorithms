...
class GeneralizeWatercourses50K(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, configuration=None):  # noqa N802
        ...
        self.addParameter(QgsProcessingParameterFeatureSink(self.OUTPUT, self.tr("Generalized")))
    ...
    def processAlgorithm(  # noqa N802
        ...
        input_layer: QgsFeatureSource = self.parameterAsVectorLayer(parameters, self.INPUT, context)

        uoma_layer: QgsFeatureSource = self.parameterAsVectorLayer(parameters, self.UOMA_LAYER, context)
        ...
        if use_uoma:
            feedback.setProgressText("Identifying natural watercourses in the input layer")
        ...
        total = 100.0 / results_layer.featureCount() if results_layer.featureCount() else 0
