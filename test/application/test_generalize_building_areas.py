...
def test_generalize_building_areas(testdata_path: Path) -> None:
    ...
    IntegrationTest(
        ...
        algorithm=GeneralizeBuildingAreas(
            ...
            geometry_simplify_tolerance_single_buildings=10.0,
            geometry_simplify_tolerance_building_areas=10.0,
            geometry_network_buffer_distance=10.0,
            ...
            gap_removal_buffer_distance=5.0,
